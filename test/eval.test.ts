...
const profile: ProfilePack = { schemaVersion: "0.1", profileId: "p", initialized: true, createdAt: "", updatedAt: "", items: [{ id: "s", kind: "fact", scope: "global", statement: "用户的健康信息", sensitivity: "high", confidence: 1, evidenceCount: 1, sourceAgents: ["user"], createdAt: "", updatedAt: "" }], presentationPolicy: { mode: "implicit_personalization", prefer: [], avoid: [] } };
