...
test("context rendering prefers holistic implicit personalization", () => {
  const profile: ProfilePack = { schemaVersion: "0.1", profileId: "p", initialized: true, createdAt: "", updatedAt: "", items: [], presentationPolicy: { mode: "implicit_personalization", prefer: ["综合多个相关维度"], avoid: ["直接点出画像标签"] } };
