...
7. After a meaningful task, call `profile_session_end` with the session object and task transcript when available. The tool stores only distilled observations, not the raw transcript.
